...
model = pickle.load(open(r"C:\Users\Suryansh SR\Desktop\SuryanshSR\STUDII\[AI] CS307\F A N U M\Reference Codes\Deployment\solar_model.pkl", 'rb'))
...
def predict():
    try:
        ...
        return render_template('solar_prediction.html',
                               prediction_text=f"Predicted Solar Energy Generation: {output:.2f} kW")
